...
Only requiring some minor changes is zixx.cpp.
...
Changes to zixx.cpp
----------------------
zixx.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

...
Zixx is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Zixx, where everyone uses
...
pay attention to for reviewers of Zixx code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Zixx uses tinyformat, which is type safe. Leave them out to avoid confusion

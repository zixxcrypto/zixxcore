...
This mechanism has been integrated into Bitcore-Node-Zixx which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zixxpay/insight-api-zixx#web-socket-api](https://github.com/zixxpay/insight-api-zixx#web-socket-api)
* API: [https://github.com/zixxpay/insight-api-zixx#instantsend-transactions](https://github.com/zixxpay/insight-api-zixx#instantsend-transactions)
...
By default, the Zixx daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Zixx daemon:

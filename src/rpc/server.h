...
extern double  RealFromValue(const UniValue& value);
...
extern UniValue ordercreatetrigger(const UniValue& params, bool fHelp);
extern UniValue orderlisttrigger(const UniValue& params, bool fHelp);
extern UniValue orderdeletetrigger(const UniValue& params, bool fHelp);
extern UniValue getqueuedtriggers(const UniValue& params, bool fHelp);
extern UniValue getvalue(const UniValue& params, bool fHelp);

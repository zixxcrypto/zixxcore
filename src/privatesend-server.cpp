...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Zixx related functionality
...
/*
    ...
    allow endless transaction that would bloat Zixx and make it unusable. To

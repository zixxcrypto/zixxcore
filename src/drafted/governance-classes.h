 ...
 *
 *   // network
 *   CZixxNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.zixx.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CZixxNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ZixxNetwork
// //   -- signature requirements : Key1(User)
// class CZixxNetworkVariable : public CGovernanceObject
// {
// private:

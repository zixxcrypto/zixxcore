    ...
    platformStyle(platformStyle)
{
    ...
    {
        progressBar->setStyleSheet("QProgressBar { background-color: #ac9253; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background-color: #ac9253; border-radius: 7px; margin: 0px; }");
    }
    else
    {
        progressBar->setStyleSheet("QProgressBar { color: #fff; } QProgressBar::chunk { background-color: #12163b; }");
    }
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZIXX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zixx: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Zixx"), this);
    aboutAction->setStatusTip(tr("Show information about Zixx"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zixx"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zixx addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zixx addresses"));
    ...
    openTOMConfEditorAction = new QAction(QIcon(":/icons/" + theme + "/edit"), tr("Open &Trigger Order Configuration File"), this);
    openTOMConfEditorAction->setStatusTip(tr("Open Trigger Order Configuration file"));
    ...
    openAction->setStatusTip(tr("Open a zixx: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zixx help message to get a list with possible Zixx command-line options"));
    ...
    connect(openTOMConfEditorAction, SIGNAL(triggered()), this, SLOT(showTOConfEditor()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    if(walletFrame)
    {
        ...
        tools->addAction(openTOMConfEditorAction);
...
void BitcoinGUI::createToolBars()
{
    ...
    if(walletFrame)
    {
        ...
        toolbar->setContentsMargins(QMargins());
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Zixx client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::createIconMenu(QMenu *pmenu)
{
    ...
    pmenu->addAction(openTOMConfEditorAction);
...
void BitcoinGUI::showTOConfEditor()
{
    GUIUtil::openTOConfigFile();
}
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zixx network", "", count));
    } else {
...
{
    QString strTitle = tr("Zixx"); // default title

    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("ZIXX");
    QString versionText     = QString(tr("Version: %1")).arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightTextBtc    = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Bitcoin Core developers"));
    QString copyrightTextDash   = QChar(0xA9)+QString(" 2014-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Dash Core developers"));
    QString copyrightTextZixx   = QChar(0xA9)+QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The ZIXX developers"));
    ...
    // Adding the font to the application.
    int id = QFontDatabase::addApplicationFont(":/fonts/nunito-light");
    QString family = QFontDatabase::applicationFontFamilies(id).at(0);
    _font_family.setFamily(family);
    QString font = _font_family.toString();
    ...
    // #797389
    pixPaint.setPen(QColor(0x79, 0x73, 0x89));
    ...
    if(titleTextWidth > 160) {
        // Strange font rendering. Shouldn't be a big problem, but fix it anyway.
        fontFactor = 0.75;
    }
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 28, copyrightTextZixx);
    ...
    if(!titleAddText.isEmpty()) {
        ...
        pixPaint.drawText(pixmap.width() - titleAddTextWidth - 10, pixmap.height() - 40, titleAddText);
    }
...
static void InitMessage(SplashScreen *splash, const std::string &message)
{
    QMetaObject::invokeMethod(splash, "showMessage",
        ...
        Q_ARG(QColor, QColor(0x12, 0x16, 0x3b)));
}
...
void SplashScreen::paintEvent(QPaintEvent *event)
{
    ...
    QRect r = rect().adjusted(300, 0, -10, -8);
    painter.setPen(curColor);
    painter.setFont(QFont(_font_family.toString(), 9 * 1.0));

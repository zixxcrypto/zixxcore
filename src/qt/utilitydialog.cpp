    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Zixx") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  zixx-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Zixx in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ZIXX, 0.1 ZIXX, 1 ZIXX and 10 ZIXX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://zixxpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://zixxpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Zixx is shutting down...") + "<br /><br />" +

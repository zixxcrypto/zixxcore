...
CAmount GetMasternodePayment(int nHeight, CAmount blockValue, bool disconsider_dev_tax = false);
...
bool CheckBlock(const CBlock& block, CValidationState& state, CBlockIndex *pIndex, bool fCheckPOW = true, bool fCheckMerkleRoot = true );
